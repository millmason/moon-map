...
Ideally, the dream is to have lunar landmarks marked out on the surface of the globe.

All we actually have right now is the ability to log out WHERE someone has clicked on the globe, and an object with the long/lat coords for several landmarks on the moon. We're currently trying to place a little flag on those points. We place it, but the direction it points in is not quite what we'd like.
